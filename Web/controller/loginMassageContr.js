...
platform.controller("loginMassageContr",['$scope','$rootScope','$http',function ($scope, $rootScope,$http) {
// ***************************************页面默认加载***********************************
    if( sessionStorage.getItem("tokenId") == null){
        ...
        $http({
            method: "POST",
            url:$rootScope.apiHome+"user/getUserInfo",
            data:{
                "phonenum":"",
                "usertype":""
            }
