 ...
 */
platform.controller("arrearsRecordsContr",['$scope','$rootScope','$http',function ($scope, $rootScope,$http) {
    //************************************************默认加载*****************************************
    if( sessionStorage.getItem("tokenId") == null){
        ...
        $http({
            method: "POST",
            url:$rootScope.apiHome+"lackballog/query",
            data:{
                "userPhone":"",
                "startTime":"",
                "endTime":"",
    ...
    $scope.search = function () {
        if( sessionStorage.getItem("tokenId") == null){
            ...
            $http({
                ...
                url:$rootScope.apiHome+"lackballog/query",
                data:{
                    "userPhone":$("#arrearsRecordsName").val(),
                    "carNumber":$("#arrearsRecordsCarNum").val(),
